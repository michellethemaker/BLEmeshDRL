...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>rimenode</description>
      <source EXPORT="discard">[CONTIKI_DIR]/examples/rime/example-multihop.c</source>
      <commands EXPORT="discard">make example-multihop.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/rime/example-multihop.sky</firmware>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>/Downloads/contiki/examples/rime/test.js</scriptfile>
      <active>true</active>
    </plugin_config>
    <width>457</width>
    <z>6</z>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>9.086862155629792 0.0 0.0 9.086862155629792 -391.8513958485212 -70.64497328950554</viewport>
    </plugin_config>
    <width>400</width>
    <z>4</z>
    <height>400</height>
